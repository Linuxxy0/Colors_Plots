    ...
    <div className="page-shell py-8">
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-2 text-4xl font-semibold text-slate-900">{language === 'zh' ? '真实主题预览，而不是图表动画' : 'Real theme preview, not chart animation'}</h1>
          <p className="mt-3 max-w-3xl text-base leading-7 text-slate-600">
            {language === 'zh' ? '左侧浏览主题，右侧查看配色在科研界面中的真实层级表现。' : 'Browse themes on the left and inspect real UI hierarchy on the right.'}
          </p>
        </div>

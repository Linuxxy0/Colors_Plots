...
export function PreviewShell({ title, subtitle, badge, theme, mode = 'card', info, children }: Props) {
  return (
    <div className={`rounded-[28px] border shadow-[0_20px_60px_rgba(15,23,42,0.06)] ${mode === 'detail' ? 'p-6' : 'p-5'}`} style={{ backgroundColor: theme.panel, borderColor: `${theme.muted}22` }}>
